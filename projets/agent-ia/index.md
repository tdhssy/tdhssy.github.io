...
**Une mémoire qui synthétise plutôt qu'une archive.** Au début je sauvegardais tout
...
**Un apprentissage sans toucher au modèle.** Mon agent savait déjà se corriger : un outil
...
**Une observabilité optionnelle par conception.** Désactivée, l'agent tourne sans aucune
dépendance. Activée, il pousse ses métriques en OTLP vers une autre machine, sans même savoir
qu'il est observé.

**Un TUI plutôt qu'une simple ligne de commande.** Inspiré d'Aider, il m'a contraint à
...
**Chercher un problème là où il n'était pas.** J'avais mis en place une authentification par
...
**Mesurer plutôt que ressentir, et découvrir qu'on se trompait.** J'évaluais l'agent au
...
Ces deux erreurs de diagnostic évitées sont, pour moi, ce que ce projet m'a le plus appris :
sans instrumentation, on optimise ce qu'on imagine, pas ce qui coûte.
